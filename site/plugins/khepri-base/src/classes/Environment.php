...
class Environment
{
    ...
    private $defaultFunctions = [
      ...
      '*esc' => 'esc',
      'error' => 'khepri\Twig\Functions::error',
      'get' => 'get',
      '*gist' => 'gist',
      'go' => 'go',
      'gravatar' => 'gravatar',
    ...
    private $defaultTests = [
      'of_type' => 'khepri\Twig\Tests::of_type',
    ];
    ...
    public function __construct(string $viewPath = '')
    {
        ...
        $options = [
            'core' => [
                'debug' => $this->debug,
                'strict_variables' => option('khepri.twig.strict', $this->debug),
                'autoescape' => option('khepri.twig.autoescape', 'html'),
                'cache' => false
            ],
            'namespace' => [
            ...
            'function' => array_merge(
                ...
                option('khepri.twig.env.functions', [])
            ),
            'extension' => option('khepri.twig.env.extensions', []),
            'filter' => option('khepri.twig.env.filters', []),
            'test' => array_merge(
              $this->defaultTests,
              option('khepri.twig.env.tests', [])
          ),
        ];

        // Set cache directory
        if (option('khepri.twig.cache')) {
        ...
        $options['paths'] = option('khepri.twig.paths', []);
